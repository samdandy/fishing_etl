...
def transform_weather_data(data):
    ...
    for period in periods:
        start_time_central = datetime.strptime(period["startTime"].replace("-05:00",""), format_string)
        end_time_central = datetime.strptime(period["endTime"].replace("-05:00",""), format_string)
